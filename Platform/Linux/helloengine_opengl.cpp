...
// Helper to check for extension string presence. Adapted form:
...
int main(void){
	...
	// Get the default screen't GLX extension list
	...
	if(!isExtensionSupported(glxExts, "GLX_ARB_create_context") || !glXCreateContextAttribsARB){
		...
		if(!ctxErrorOccurred && context){
			...
			printf("Failed to crate GL 3.0 context ... using old-style GLX context\n");
