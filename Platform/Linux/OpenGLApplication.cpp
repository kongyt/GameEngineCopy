...
namespace GE{
    GfxConfiguration config(8, 8, 8, 8, 24, 8, 0, 960, 540, "Game Engine Copy(Linux)");
...
int GE::OpenGLApplication::Initialize()
{
    int result;
...
void GE::OpenGLApplication::Finalize()
{
    XcbApplication::Finalize();
}

void GE::OpenGLApplication::Tick()
{
    XcbApplication::Tick();
}

void GE::OpenGLApplication::OnDraw()
{
