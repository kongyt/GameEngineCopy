#ifndef __GfxConfiguration_H__
#define __GfxConfiguration_H__
...
namespace GE{
	...
	struct GfxConfiguration{
		/// Inline all-enements constructor.
		...
		GfxConfiguration(uint32_t r = 8, uint32_t g = 8,
			...
			uint32_t width = 1920, uint32_t height = 1080, const char* app_name="GameEngineCopy"):
