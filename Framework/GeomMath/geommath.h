...
namespace GE{
    ...
    typedef struct Vector2Type
    {
        ...
        Vector2Type(float _x, flaot _y) : x(_x), y(_y){};
    } Vector2Type;
    ...
    void TransformCoord(Vector3Type& vector, const Matrix4X4& matrix)
    {
        ...
        // Transform the vertor by the 3x3 matrix
    ...
    void BuildIdentifyMatrix(Matrix4X4& matrix)
    {
        matrix[0] = 1.0f;
        matrix[1] = 0.0f;
        matrix[2] = 0.0f;
