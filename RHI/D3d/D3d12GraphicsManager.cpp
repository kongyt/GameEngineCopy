	...
	static void GetHardwareAdapter(IDXGIFactory4* pFactory, IDXGIAdapter1** ppAdapter)
	{
		...
		*ppAdapter = nullptr;
		...
		for(UINT adapterIndex = 0; DXGI_ERROR_NOT_FOUND != pFactory->EnumAdapters1(adapterIndex, &pAdapter); adapterIndex++)
		{
			...
			{
				// Dot't select the Basic Render Driver adapter.
				continue;
			}
...
HRESULT GE::D3d12GraphicsManager::CreateRenderTarget()
{
	HRESULT hr;
...
HRESULT GE::D3d12GraphicsManager::CreateGraphicsResources()
{
	HRESULT hr;
...
int GE::D3d12GraphicsManager::Initialize()
{
	int result = 0;
...
void GE::D3d12GraphicsManager::Tick()
{
	
}

void GE::D3d12GraphicsManager::Finalize()
{
